import 'package:untitled/screens/content/chat.dart';
import 'package:untitled/screens/content/create_chat.dart';
import 'package:untitled/widgets/chat_tile.dart';
                      ...
                      return Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Veriler alinirken bir hata oluştu.',
                    ...
                    if (snapshot.data?.snapshot.value == null) {
                      return Center(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Henüz sohbet baslatmadin mi?',
                              style: Theme.of(context).textTheme.headline5,
                            ),
                            const SizedBox(height: 10),
                            Text(
                              'Bir sohbet başlatmak için butona tiklayin.',
