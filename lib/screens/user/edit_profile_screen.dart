import 'package:untitled/controllers/custom_getx_controller.dart';
import 'package:untitled/core/firebase/database/database.dart';
import 'package:untitled/core/firebase/store/storage.dart';
import 'package:untitled/widgets/change_profile_image.dart';
import 'package:untitled/widgets/custom_snack_bar.dart';
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            CustomSnackBar(
                              message:
                                  'Bilgileriniz Guncellenirken Bir Hata Oldu: $e',
                              margin: const EdgeInsets.only(bottom: 200),
                            ),
                          );
                        }
                      },
                      text: 'Degisiklikleri Kaydet',
                    ),
                  ),
                ),
                const SizedBox(height: 32),
