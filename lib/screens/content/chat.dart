...
import 'package:untitled/core/services/api/api.dart';
import 'package:emoji_picker_flutter/emoji_picker_flutter.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:firebase_database/ui/firebase_animated_list.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:untitled/widgets/chat_message.dart';
  ...
  void _handleChatSubmit({
    ...
    if (_formKey.currentState!.validate()) {
      ...
      gptData = await Api().generateText(
        messages: data,
        context: context,
        apiKey: "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",
      );
      setState(() {
        isLoading = false;
      });
